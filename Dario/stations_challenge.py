...
class SubwayStation(Station):
    ...
    def show_info(self):
        ...
        print(f'The following lines stop at {self.station_name}')
        print(self.lines)
...
lines: ['1', '2', '3', 'L']
'''
fourteenth_street_station = SubwayStation(station_name = '14th street', location = '14th street and 7th avenue', lines = ['1', '2', '3', 'L'])
print(fourteenth_street_station.show_info())
print()
...
class BusStation(Station):
    ...
    def open_station(self):
        self.open = True
        print(f'{self.station_name} is open at 6am')

    def close_station(self):
        self.open = False
        print(f'{self.station_name} is closed at 2am')
...
'''
print()
penn_station = BusStation(station_name = 'NYC Megabus Stop', location = '34th street and 12th avenue', \
routes = ['Boston', 'DC', 'Philly'])
print(penn_station.show_info())
print(penn_station.open_station())
print(penn_station.close_station())
print()
