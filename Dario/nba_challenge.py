...
print(f"In the 2020 NBA playoffs, the three point percentage for Jamal Murray was {jamal_murray_3pts_made/jamal_murray_3pt_shot_attempts}")
# TODO: Calculate and print the 3 point percentage for Fred VanVleet
print(f"In the 2020 NBA playoffs, the three point percentage for Fred VanVleet was {fred_vanvleet_3pts_made/fred_vanvleet_3pt_shot_attempts}")
# TODO: Calculate and print the 3 point percentage for James Harden
print(f"In the 2020 NBA playoffs, the three point percentage for James Harden was {james_harden_3pts_made/james_harden_3pt_shot_attempts}")
print()

print('Challenge 3.1: Print out the paragraph but with only 1 sentence per line')
# TODO: Print the giant chunk of text out using escape characters so each sentence comes out on a new line
print(f"The Lakers went all in this offseason and swung a deal with former Pelicans forward Anthony Davis. \
...
\nLos Angeles has ridden James and Davis, along witha supporting cast built around them, to the second-best record in the NBA. \
...
\nDavis proved to be the final piece necessary for the Lakers to rebound from missing the playoffs last year. \
...
paragraph = (f"The Lakers went all in this offseason and swung a deal with former Pelicans forward Anthony Davis. \
\nThey sent a package of Brandon Ingram, Lonzo Ball, Josh Hart, and 3 first-round picks to New Orleans to land Davis. \
\nThose three have made good developments with the Pelicans, especially Brandon Ingram. \
\nBut, the deal is still a huge win for the Lakers as Lebron, Davis and company have put together an incredible season. \
\nLos Angeles has ridden James and Davis, along witha supporting cast built around them, to the second-best record in the NBA. \
