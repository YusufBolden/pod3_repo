...
print('\nPart 5\n')
nyt_bestseller = Booklist()
nyt_bestseller.add("The Wish", "Nicholas Sparks")
nyt_bestseller.add("The Man Who Died Twice", "Richard Osman")

print(nyt_bestseller.books)
...
print('\nBONUS Part 6\n')
print(my_library.display_titles(my_library.books))
print(nyt_bestseller.display_titles(nyt_bestseller.books))
