...
class SubwayStation(Station):
    def __init__(self, station_name, location, lines):
        ...
        self.lines = lines
    def show_info(self):
        print(f'{self.station_name} station is located at {self.location} and lines {self.lines} are traveled here.')
...
class BusStation(Station):
    ...
    def show_info(self):
        if self.open == True:
            print(f'{self.station_name} station is located at {self.location} and is now open to travel the following routes: {self.routes}.')
        else:
            print(f'{self.station_name} station is located at {self.location} and is currently closed.')
...
'''
bus_station1 = BusStation(station_name = 'NYC Megabus stop',location = '34th street and 12th avenue',routes = ['Boston', 'DC', 'Philly'] )

bus_station1.show_info()
bus_station1.closed_station()
bus_station1.show_info()
