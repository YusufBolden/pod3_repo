...
print(f"The longitude and latitude of the Four Barrel Coffee spot is {restaurant['longitude']}, and {restaurant['latitude']}")
# TODO: Write code to print the complete address of the Four Barrel Coffee, formatted as a string - it should include the address, city, state and the zip code.
print()
print(f"The address to the {restaurant['name']} restaurant is {restaurant['address1']}, {restaurant['city']}, {restaurant['state']} {restaurant['zip_code']}.")
...
restaurant3.pop('favourite_dish')
