...
# The object books is a list which is varified by the types function. That carries many strings.
print(type(books))
...
# The type of data is a list with a bunch of dictionaries within it, dictated by the {} within the lists.
...
def search_by_author(author):
    ...
    for book in books_with_details:
        if book['author'] == author:
            author_books.append(book['title']) # this line is looking for books with the author's name and giving his titles.
    return author_books        
#above is the syntax to actually access this material.
