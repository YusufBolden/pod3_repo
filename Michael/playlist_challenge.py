...
add_song(my_playlist , {'artist': 'Kendrick Lamar', 'title' : 'Swimming Pools'})
...
print('Question 5')
add_song(my_playlist , {'artist': 'Kendrick Lamar', 'title' : 'Watch out for detox'})
add_song(my_playlist , {'artist': 'Kendrick Lamar', 'title' : 'Kill My Vibe'})
display_playlist(my_playlist)
