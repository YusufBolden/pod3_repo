...
class SubwayStation(Station):
    ...
    def show_info(self):
        print(f'{self.station_name} station is located at {self.location} and {self.lines} stop here')    
...
lines: ['1', '2', '3', 'L']
'''
subway_station1 = SubwayStation(station_name= '14th street', location= '14th street and 7th avenue', lines= ['1', '2', '3', 'L'])
...
class BusStation(Station):
    ...
    def open_station(self):
        self.open = True
        print(f'{self.station_name} is now open')

    def close_station(self):
        self.open = False
        print(f'{self.station_name} is now closed')

    def show_info(self):
        if self.open:
            print(f'{self.station_name} station is located at {self.location} and stops here {self.routes}. and it is opened')

        else:
            print(f'{self.station_name} station is located at {self.location} and stops here {self.routes} and it is closed')   
