...
james_harden_3pts_made = 121
Fred_VanVleet_3pts_made = 174
...
jamal_murray_3PA = 6.6
james_harden_3PA = 7.6
fred_vanvleet_3PA = 9.2
print()
...
print(f"In the 2020 NBA playoffs, Jamal Murray made {jamal_murray_3pts_made} 3 point shots and {jamal_murray_3PA} 3 point attempts.")
print(f"In the 2020 NBA playoffs, James Harden made {james_harden_3pts_made} 3 point shots and {james_harden_3PA} 3 point attempts.")
print(f"In the 2020 NBA playoffs, Fred VanVleet made {Fred_VanVleet_3pts_made} 3 point shots and {fred_vanvleet_3PA} 3 point attempts.")
print()
...
Jamal_Murray_3PP = jamal_murray_3pts_made/jamal_murray_3PA
James_Harden_3PP = james_harden_3pts_made/james_harden_3PA
Fred_VanVleet_3PP = Fred_VanVleet_3pts_made/fred_vanvleet_3PA
print(Jamal_Murray_3PP, James_Harden_3PP, Fred_VanVleet_3PP)
...
print(f'Many people think the lakers are the best, but that thinking is {lakers_are_best}')
...
print(str(Jamal_Murray_3PP))
print(str(James_Harden_3PP))
print(str(Fred_VanVleet_3PP))

print(int(Jamal_Murray_3PP))
print(int(James_Harden_3PP))
print(int(Fred_VanVleet_3PP))
