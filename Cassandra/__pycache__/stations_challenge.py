...
class SubwayStation(Station):
    ...
    def show_info(self):
        print(f'{self.station_name} station is located at {self.location} and the stops are {self.lines}')

class BusStation(Station):
    def __init__(self, station_name, location, lines, routes):
        super().__init__(station_name, location)
        self.routes = routes
        self.open = True(self):
...
station1 = SubwayStation(station_name= '14th street' , location= '14th street and 7th avenue' lines= ['1', '2', '3', 'L'] print('Question 3: Making the BusStation Class')
...
'''
station1 = BusSatation(station_name = ' NYC megabus stop', location = '34th Street and 12th avenue' , routes = ['Boston', 'DC', Philly'])
station1.open_station()
