...
'''
add_song(my_playlist, {"artist": "Lauren Diagle", "title": "I Believe"})

# 4 Check that you've added the song by running the display_playlist() function again
print('Question 4')
print("Checking added song(s) on the list".upper())  
print()
display_playlist(my_playlist)
...
add_song(my_playlist, {"artist": "Kirk Franklin", "title": "Smile"})
add_song(my_playlist, {"artist": "Because of You Are": Martha Munnzzi"})
display_playlist(my_playlist)
