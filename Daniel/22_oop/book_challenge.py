...
# remove only 'Just Mercy' and check by printing
...
# initialize new object, add books, print books

nyt_bestsellers = Booklist()

nyt_bestsellers.add('The Wish', 'Nicholas Sparks')
nyt_bestsellers.add('The Butler', 'Danielle Steel')
