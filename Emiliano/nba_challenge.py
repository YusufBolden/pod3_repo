...
# TODO: Create variable here for number of 3 pt shots made by James Hardengit 
...
print(f'In the 2020 NBA playoffs, James Hardin {james_harden_3pts_made} 3 point shots.')
...
fred_vanvleet_attempts_made = 110
# TODO: Create variable here for number of 3 pt shot attempts by James Harden
james_harden_attempts_made = 109

print(f"In the 2020 NBA playoffs, Jamal Murray attempted {jamal_murray_attempts_made} 3 point shots.")
print(f"In the 2020 NBA playoffs, Fred VanVleet attmpted {fred_vanvleet_attempts_made} 3 point shots.")
print(f"In the 2020 NBA playoffs, James Harden attempted {james_harden_attempts_made} 3 point shots.")
...
print(f"In the 2020 NBA playoff's, Jamal Murray made {jamal_murray_3pts_made} 3 point shots and attempted {jamal_murray_attempts_made}.")
print(f"In the 2020 NBA playoff's, Jamal Murray made {fred_vanvleet_3pts_made} 3 point shots and attempted {fred_vanvleet_attempts_made}.")
print(f"In the 2020 NBA playoff's, Jamal Murray made {james_harden_3pts_made} 3 point shots and attempted {james_harden_attempts_made}.")
...
print(f'In the NBA 2020 playoffs Jamal Murray averaged {(jamal_murray_3pts_made/jamal_murray_attempts_made)}%')
# TODO: Calculate and print the 3 point percentage for Fred VanVleet
print(f'In the NBA 2020 playoffs Fred VanVleet averaged {(fred_vanvleet_3pts_made/fred_vanvleet_attempts_made)}%')
# TODO: Calculate and print the 3 point percentage for James Harden
print(f'In the NBA 2020 playoffs Jamal Harden averaged {(james_harden_3pts_made/james_harden_attempts_made)}%')
...
Those three have made good developments with the Pelicans, especially Brandon Ingram. But, the deal is still a huge win for the Lakers as Lebron, Davis, \
and company have put together an incredible season. Los Angeles has ridden James and Davis, along with a supporting cast built around them, to the second-best \
    \nrecord in the NBA. The Lakers ended the season atop the Western Conference with a record of 49-14. They were narrowly behind the Bucks for the best record in the league. \nDavis proved to the final piece necessary for the Lakers to rebound from missing the playoffís last year. \nLos Angeles was a dominant club on both sides of the ball and are in a position to have another successful year next season.")
...
print('The Lakers went all in this offseason and swung a deal for former Pelicans forward Anthony Davis. \
    ...
    \n Davis proved to the final piece necessary for the Lakers to rebound from missing the playoffís last year. \nLos Angeles was a dominant club on both sides of \
    the ball and are in a position to have another successful year next season.')
...
print(f'The Lakers ended the season atop the Western Conference with a record of 49-14, the Lakers are the best team! {lakers_are_best}' )

print('Challenge 3.4: Type Conversion')
# TODO: Convert your `lakers_are_best` variable to an integer, and print it out.
print(f'Lakers are the best {int(lakers_are_best)}') 
# TODO: Convert your `lakers_are best` variable to a float, and print it out
print(f'Lakers are the best{float(lakers_are_best)}')

print('Challenge 3.5: Type Conversion Part 2')
# TODO: Take each player's three point percentage (from part 2.5) and convert it to a string, then print it out.
print(f'{type(jamal_murray_3pts_made/jamal_murray_attempts_made)}')
print(f'{type(fred_vanvleet_3pts_made/fred_vanvleet_attempts_made)}')
print(f'{type(james_harden_3pts_made/james_harden_attempts_made)}')
# TODO: Take each player's three point percentage (from part 2.5) and convert it to an integer, then print it out.
print(f'{int(jamal_murray_3pts_made/jamal_murray_attempts_made)}')
print(f'{int(fred_vanvleet_3pts_made/fred_vanvleet_attempts_made)}')
print(f'{int(james_harden_3pts_made/james_harden_attempts_made)}')