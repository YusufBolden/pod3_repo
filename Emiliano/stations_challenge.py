...
class SubwayStation(Station):
    def __init__(self,station_name, location, lines):
        super().__init__(station_name, location) #super is... 
        self.lines = lines
        
    def show_info(self):
        print(f"{self.station_name} station is located at {self.location} lines {self.lines} stops at {self.station_name}")
...
class BusStation(Station):
    ...
    def show_info(self):
        if self.open:
            print(f"{self.station_name} station is located at {self.location} stops at {self.routes} {self.show_info}")    
